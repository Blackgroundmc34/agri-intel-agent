...
# Get frontend origin from environment variables, defaulting to a local dev server
frontend_origin = os.getenv("FRONTEND_ORIGIN", "http://localhost:3000")
origins = [frontend_origin, "http://localhost:3000"] # Allow both Vercel and local dev
...
def get_weather_data(location: str) -> dict:
    ...
    You will need to replace this with a real API call.
    """
...
if __name__ == "__main__":
    import uvicorn
    # The port is read from the environment variable, which will be 8080 on Railway.
    # We still use a default of 8080 for local testing.
